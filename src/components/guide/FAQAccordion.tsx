...
const faqData: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      '현재 10가구가 입주하여 평화롭게 생활하고 있습니다. 이미 형성된 커뮤니티가 있어 새로 입주하시는 분들도 외롭지 않게 전원생활을 시작하실 수 있습니다.',
  },
  {
    category: '일반',
    question: '단지 규모는 어떻게 되나요?',
    answer:
      '전체 약 8,200평 대지에 100~200평 규모의 필지로 구획되어 있습니다. 총 60세대 규모로 계획되어 있으며, 중소형(17, 25, 32평) 주택부터 대형 주택까지 다양한 선택이 가능합니다.',
  },
  {
    category: '일반',
  ...
  },
  {
    ...
    answer:
      '평형과 마감재에 따라 다릅니다. 15평형 실속형(경량철골)은 약 5,500~6,500만원, 36평형 정통 목조/철골 구조는 1.5억 원 이상입니다. 이아소에서는 예산에 맞춘 맞춤형 건축 컨설팅을 제공합니다.',
  },
  {
    category: '비용',
    question: '관리비는 얼마인가요?',
